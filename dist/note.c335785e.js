...
})({"4kbbB":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "de5cd8f3c335785e";
...
},{}],"cFXRS":[function(require,module,exports) {
// Note App Project
// ===========================
...
addBtn.onclick = ()=>{
    ...
    if (userNote.length > 50 && userNoteExcerpt.charAt(userNoteExcerpt.length - 1) != ' ') newCardText.innerText = userNoteExcerpt + '...';
    else if (userNote.length > 50 && userNoteExcerpt.endsWith(' ')) {
        let excerptTrim = userNoteExcerpt.trim();
        newCardText.innerText = excerptTrim + '...';
    } else newCardText.innerText = userNote; //Adds full user note into card.
...
},{}]},["4kbbB","cFXRS"], "cFXRS", "parcelRequiree04d")

//# sourceMappingURL=note.c335785e.js.map
